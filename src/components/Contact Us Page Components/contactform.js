            ...
            <div className="mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row items-stretch justify-center">
                    <div className="md:pr-6 mb-6 md:mb-0">
                        <p className="mt-3 text-lg text-gray-500">For urgent matters: Email us at <a href="mailto:info@abyauniversity.com" className="text-yellow-400">info@abyauniversity.com</a></p>
                        ...
                        <ul className="list-none p-0">
                            <li className="flex items-center mb-4">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mb-1 text-base text-gray-500">Crystal Business Plaza</p>
                                    <p className="text-base text-gray-500">Ongata Rongai, Kenya</p>
                                </div>
                            </li>
                            ...
                            <li className="flex items-center mb-4">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mb-1 text-base text-gray-500">Mobile: + (254)- 797 546 916</p>
                                    <p className="text-base text-gray-500">Mail: info@abyauniversity.com</p>
                                </div>
                            </li>
                            ...
                            <li className="flex items-center mb-4">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-base text-gray-500">Saturday 08:00 - 12:00</p>
                                </div>
                            </li>
                        </ul>
                    </div>
