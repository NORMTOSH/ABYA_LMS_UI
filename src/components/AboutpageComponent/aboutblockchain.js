...
const AboutBlockchain = () => {
    return (
        ...
        <div className="px-4 mx-auto text-center pt-10 dark:bg-gray-900">
            ...
            <div className="py-8 ps-12 mx-auto items-center justify-center container lg:py-16 dark:bg-gray-900">
                <div className="flex flex-col md:flex-row md:items-center text-center px-6 md:justify-between">
                    ...
                    <div class="hidden md:block relative px-[70px] items-center justify-center mx-auto">
                        <div class="w-1 lg:h-[500px] md:h-[800px]  bg-gray-400 shadow-lg shadow-yellow-400 dark:bg-gray-700"></div>
                    </div>
                    <div className="w-full md:w-1/2"> 
                        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            <div class="flex flex-col py-1 mb-4">
                            <dd class="text-xl font-semibold">More than just technology:</dd>
                            <span>
                                ABYA University is not just about technology; it&apos;s about people and creating a thriving community. We value:</span>
                            </div>
