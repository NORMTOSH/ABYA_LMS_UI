    ...
    <section className="bg-gray-500 bg-opacity-50 dark:bg-gray-900 p-2">
        <div className="container mx-auto m-2 p-2">
            <div className=" mb-8 lg:mb-16">
                <h2 className="mb-2 text-3xl tracking-tight font-bold mx-auto text-center text-gray-100 dark:text-white">Why Join the ABYA Community?</h2>
            </div>
            <div className='grid lg:grid-cols-3 md:grid-cols-2 items-center justify-center lg:justify-around gap-2 md:gap-4 space-y-2 '>
