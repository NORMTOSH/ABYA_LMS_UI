...
const Features = () => {
    return ( 
        <section id="features" className="p-3 h-auto dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-800 bg-gradient-to-b from-gray-300 to-gray-500">
            ...
            <div className="container mx-auto m-2 p-5 grid gap-4 md:grid-cols-2 lg:grid-cols-3 items-center justify-center">
            <div className="flex flex-col w-full md:w-1/2 lg:w-[90%] dark:border-b dark:border-yellow-400 bg-transparent rounded-lg dark:bg-gray-800 ">
    <a href="#">
        <img className="p-8 w-1/2 rounded-t-lg" src="learn.png" alt="product image" />
    </a>
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-yellow-400">Learn</h5>
        </a>
...
<div className="flex flex-col w-full md:w-1/2 lg:w-[90%] bg-transparent dark:border-b rounded-lg dark:bg-gray-800 dark:border-yellow-400">
    <a href="#">
        <img className="p-8 w-1/2 rounded-t-lg" src="transparency.png" alt="product image" />
    </a>
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-yellow-400">Contribute</h5>
        </a>
...
<div className="flex flex-col w-full md:w-1/2 lg:w-[90%] bg-transparent dark:border-b rounded-lg dark:bg-gray-800 dark:border-yellow-400">
    ...
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-yellow-400">Govern</h5>
        </a>
...
<div className="flex flex-col w-full md:w-1/2 lg:w-[90%] bg-transparent dark:border-b  rounded-lg dark:bg-gray-800 dark:border-yellow-400">
    ...
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-yellow-400">Connect</h5>
        </a>
...
<div className="flex flex-col w-full md:w-1/2 lg:w-[90%] bg-transparent dark:border-b  rounded-lg dark:bg-gray-800 dark:border-yellow-400">
    ...
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-yellow-400">Own Your Data</h5>
        </a>
