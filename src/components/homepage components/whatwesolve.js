...
const Whatwesolve = () => {
    return (
        <section id="whatwesolve" className="items-center justify-center dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-800 bg-gradient-to-b from-gray-100 to-gray-300 pt-[200px] md:pt-[5px] lg:pt-2">
            ...
            <div className="container md:container md:items-center md:justify-center md:ml-6 mx-auto p-5 grid gap-4 md:grid-cols-2 lg:grid-cols-3 items-center justify-center lg:justify-center lg:items-center lg:mx-auto lg:place-content-center lg:place-items-center">
