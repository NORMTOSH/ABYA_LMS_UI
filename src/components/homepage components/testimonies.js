...
<section className="bg-gradient-to-b from-gray-500 to-gray-300 dark:bg-gradient dark:from-gray-800 dark:to-gray-800">
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 className="mb-4 text-2xl font-semibold tracking-tight mt-2 pt-2 text-gray-900 dark:text-white">Testimonies</h2>
      ...
      <div className="container mx-auto p-5 grid gap-4 md:grid-cols-2 lg:grid-cols-3 items-center justify-center">
      <div className="flex flex-col items-center p-2 lg:w-[98%] bg-gray-100 shadow-lg  rounded-lg dark:bg-gray-800 dark:border-gray-700">
              ...
              <h2 className="text-md font-light tracking-tight text-gray-900 dark:text-white">Meet </h2>
              <a className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Bonnie Green,</a>
              <h3 className="mb-1 tracking-tight text-gray-900 dark:text-white">
                  <a href="#"><span>a bright student from Nairobi:</span></a>
              </h3>
              <p>Traditional education felt distant and unaffordable.</p>
              <p>With ABYA University, he:</p>
              <ul className="list-none pl-0">
                    <li className="flex items-left text-left mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                        Learned programming skills through diverse courses and resources.
                    </li>
                    <li className="flex items-left text-left mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                        Earned tokens by creating tutorials and helping others.
                    </li>
                    <li className="flex items-left mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                        <span className="items-start text-left">Connected with mentors and built a global network.</span>
                    </li>
                    <li className="flex items-left mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                        Landed her dream job as a developer, breaking free from limitations.
                    </li>
              </ul>
          ...
          <div className="flex flex-col items-center p-2 lg:w-[90%] bg-gray-50 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <h2 className="text-md font-light tracking-tight text-gray-900 dark:text-white">Meet </h2>
              <a className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Leslie Livingston,</a>
              <h3 className="mb-1 tracking-tight text-gray-900 dark:text-white">
                  <a href="#"><span>a bright student from Austria:</span></a>
              </h3>
              <p>Traditional education felt distant and unaffordable.</p>
              <p>With ABYA University, he:</p>
              <ul className="list-none pl-0">
                    ...
                    <li className="flex items-left text-left mb-2">
                        ...
                        Connected with mentors and built a global network.
                    </li>
                    <li className="flex items-left text-left mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="flex flex-col items-center p-2 lg:w-[90%] bg-gray-50 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <h2 className="text-md font-light tracking-tight text-gray-900 dark:text-white">Meet </h2>
              <a className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Michael Gough,</a>
              <h3 className="mb-1 tracking-tight text-gray-900 dark:text-white">
                  <a href="#"><span>a bright student from India:</span></a>
              </h3>
              <p>Traditional education felt distant and unaffordable.</p>
              <p>With ABYA University, he:</p>
              <ul className="list-none pl-0">
          ...
          <div className="flex flex-col items-center p-2 lg:w-[90%] bg-gray-50 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <h2 className="text-md font-light tracking-tight text-gray-900 dark:text-white">Meet </h2>
              <a className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Neil Sims,</a>
              <h3 className="mb-1 tracking-tight text-gray-900 dark:text-white">
                  <a href="#"><span>a bright student from Nigeria:</span></a>
              </h3>
              <p>Traditional education felt distant and unaffordable.</p>
              <p>With ABYA University, he:</p>
              <ul className="list-none pl-0">
